...
function App(props) {
  return (
    <BrowserRouter>
      ...
      <Route exact path='/graphic' render={()=><Workplace type_header='Step 3. Graphic building' type='graphic' needState={props.state.graphic} needFunctions={props.state.graphicFunctions}/>}/>
    </BrowserRouter>
  );
}
